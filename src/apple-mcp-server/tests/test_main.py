...
from awslabs.apple_mcp_server.server import main
...
class TestMain:
    ...
    @patch('awslabs.apple_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.apple-mcp-server'])
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.apple_mcp_server import server
