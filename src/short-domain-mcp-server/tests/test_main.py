...
from awslabs.short_domain_mcp_server.server import main
...
class TestMain:
    ...
    @patch('awslabs.short_domain_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.short-domain-mcp-server'])
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.short_domain_mcp_server import server
