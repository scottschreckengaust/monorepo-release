...
from awslabs.one_mcp_server.server import main
...
class TestMain:
    ...
    @patch('awslabs.one_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.one-mcp-server'])
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.one_mcp_server import server
